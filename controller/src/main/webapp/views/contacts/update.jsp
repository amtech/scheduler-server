	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-horizontal" role="form">
				<div class="form-body">
                    <input id="contactsId" type="hidden" value="${contacts.id}">
					<div class="form-group">
						<label class="col-md-2 control-label">姓名</label>
						<div class="col-md-10">
							<input  id="contactsName" class="form-control input-inline input-medium" type="text"
								placeholder="Enter text" value="${contacts.name}">
					...
					<div class="form-group" class="example" style="align: center">
						...
						<div class="col-md-10">
							<input  id="contactsMail" style="float: left;"
								...
								placeholder="Enter text" value="${contacts.mail}">
					...
					<div class="form-group" class="example" style="align: center">
						...
						<div class="col-md-10">
							<input id="phoneNo" style="float: left;"
								class="form-control input-inline input-medium" type="text"
								placeholder="Enter text" value="${contacts.phoneNo}">
...
<div class="modal-footer">
	...
	<button id="save" type="button" class="btn blue" onclick="modify();">确认</button>
</div>
